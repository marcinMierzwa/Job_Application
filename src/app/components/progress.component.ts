...
@Component({
  ...
  template: `
    <div
      class="progress-width ms-auto d-flex align-items-center gap-3 border border-primary border-opacity-50 py-1 px-2 rounded-4"
    >
      ...
      <div
        ...
        aria-valuemax="100"
      >
        <div class="progress-bar" [style.width]="progressOptions().value">
